...
dvfs = ["0x1d00", "0x1b00", "0x1900", "0x1700",
        "0x1500", "0x1300", "0x1100", "0xf00", "0xd00"]
...
for line in f:
    ...
    cdvfs = tmp[3]
    crapl = tmp[4]
    cqps = possible_qps_vals[np.argmin(np.abs((int(float(tmp[5])) - possible_qps_vals)))]
    cdict[str(ci)+" "+str(citr)+" "+str(cdvfs)+" "+str(crapl)+" "+str(cqps)] = 1
    #print(ci, citr, cdvfs, crapl, cqps)
f.close()
#print(cdict)
#exit()
        ...
        for qps in qpss:
            for rapl in rapls:            
                for i in range(0, iters):
                    # check ebbrt_8_8.csv
                    if str(i)+" "+str(itr)+" "+str(d)+" "+str(rapl)+" "+str(qps) in cdict:
                        print(str(i)+" "+str(itr)+" "+str(d)+" "+str(rapl)+" "+str(qps), "already done")
                        break
                    else:
                        print(str(i)+" "+str(itr)+" "+str(d)+" "+str(rapl)+" "+str(qps), "not done")
                    ...
                    while check_done == True:
                        fname = 'ebbrt_dmesg.'+str(i)+'_'+str(15)+'_'+itr+'_'+d+'_'+rapl+'_'+qps+'.csv'
