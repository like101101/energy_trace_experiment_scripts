...
com_dict = {
    "com1" : 'ssh 192.168.1.11 taskset -c 1 /app/wrk-4.0.2/wrk -t1 -c1 -d30s http://192.168.1.200:6666/index.html --latency',
...
def runWrkEbbRT():
    ...
    f = open("ebbrt_out."+str(NREPEAT)+"_1_"+str(int(ITR)*2)+"_"+str(DVFS)+"_"+str(RAPL), 'w')
