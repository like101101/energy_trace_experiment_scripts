                ...
                for i in range(0, iters):
                    ...
                    if path.exists(fname):                    
                        ...
                        if START_RDTSC == 0 or END_RDTSC == 0 or tdiff < 3:
                            ...
                            df['refc_diff'] = df['ref_cycles'].diff()
